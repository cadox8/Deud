package es.cadox8.deud.entities.statics.rock;
...
public class Rock extends StaticEntity {
    ...
    public Rock(@NonNull GameAPI gameAPI, float x, float y) {
        super("91d334fe-5322-42d7-8a0d-3cebb6a173d4", "Rock", EntityType.ROCK, gameAPI, x, y, Tile.TILEWIDTH, Tile.TILEHEIGHT);
