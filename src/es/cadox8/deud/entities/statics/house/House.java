package es.cadox8.deud.entities.statics.house;
...
public class House extends StaticEntity {
    ...
    public House(@NonNull GameAPI gameAPI, float x, float y, int houseType) {
        super("3472051a-67ed-49f5-b566-d0d893ffaa66", "House", EntityType.HOUSE, gameAPI, x, y, Tile.TILEWIDTH, Tile.TILEHEIGHT);
    ...
    private BufferedImage getImage(int type, int index) {
        return switch (type) {
            case 2, 4 -> Assets.house2[index];
            case 3, 5 -> Assets.house3[index];
            default -> Assets.house1[index];
        };
    }
}
