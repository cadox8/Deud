...
public class Path {
    ...
    public Path(int[][] maze, int xstart, int ystart) {
        this(maze, xstart, ystart, false);
    }
    public Path(int[][] maze, int xstart, int ystart, boolean diag) {
...
/*                System.out.println((x != 0 || y != 0));
    ...
    public static void main(String[] args) {
        ...
        Path as = new Path(maze, 0, 0, true);
