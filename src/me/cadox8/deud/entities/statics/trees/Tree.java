...
public abstract class Tree extends StaticEntity {
    ...
    public Tree(int id, String name, GameAPI gameAPI, float x, float y) {
        this (id, name, gameAPI, x, y, Tile.TILEWIDTH, Tile.TILEHEIGHT);
    }
    public Tree(int id, String name, GameAPI gameAPI, float x, float y, int width, int height) {
